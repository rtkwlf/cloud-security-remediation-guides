...
6. Navigate to "Compute Engine", choose "VM Instances". From the panel on the right side, click on "Labels" and then click on the checkbox next to the name of the "Instance" which needs to have labels added.</br> <img src="/resources/google/compute/instance-labels-added/step6.png"/>
