...
2. Search for policy and select it from the list. </br> <img src="/resources/azure/azurepolicy/resource-location-matches-resource-group/step2.png"/>
...
7. On the "Available Definitions" page, click on the "Search" box and search for "Resource Location Matches Resource Group". Click the Policy Definition found and then click "Add" button at the bottom.</br> <img src="/resources/azure/azurepolicy/resource-location-matches-resource-group/step7.png"/>
8. Once back on the "Assign Policy" page, provide a "Description" and click on the "Next" to view Parameters tab. If the policy definition you selected on the Basics tab has parameters, you configure them on the Parameters tab. Click Next to view Remediation tab.</br> <img src="/resources/azure/azurepolicy/resource-location-matches-resource-group/step8.png"/>
