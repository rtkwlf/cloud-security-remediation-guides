...
5. On the "Settings | Defender plans" page, select the "Settings & Monitoring" Tab on the top. </br> <img src="/resources/azure/defender/security-configuration-monitoring/step5.png"/>
6. On the "Settings & Monitoring" page, Navigate to the "Guest Configuration agent" plan. </br> <img src="/resources/azure/defender/security-configuration-monitoring/step6.png"/>
