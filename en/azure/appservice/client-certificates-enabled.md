...
4. On left navigation panel that opens, click on Configuration tab under Settings.</br> <img src="/resources/azure/appservice/client-certificates-enabled/step4.png"/>
...
6. Scroll down to check for Incoming client certificates at the bottom and select "Required".</br> <img src="/resources/azure/appservice/client-certificates-enabled/step6.png"/>
7. Repeat steps from 3 to 6 to ensure "Client Certificates" are enabled for all "App Services", only allowing clients with valid certificates to reach the app. </br>
