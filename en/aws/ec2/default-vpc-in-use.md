...
16. Click on the "Review and Launch" button once reviewing the necessary configuration to launch the new "EC2-Instance". Once the new "EC2-Instance" is in healthy state remove the older "EC2-Instance" which is using the default VPC.</br> <img src="/resources/aws/ec2/default-vpc-in-use/step16.png"/>
